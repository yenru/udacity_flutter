...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  Future<void> _retrieveApiCategory() async {
    ...
    setState(() {
      // 建立一個空白的Category在_categories清單最下方
      _categories.add(Category(
        name: apiCategory['name'],  //from api.dart
        units: [],
  ...
  Widget build(BuildContext context) {
    ...
    // https://medium.com/flutter-io/decomposing-widgets-backdrop-b5c664fb9cf4
    return Backdrop(
      currentCategory:
